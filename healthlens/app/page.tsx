      ...
      <div className="mx-auto flex w-full max-w-[430px] flex-col">
        ...
        <section className="mx-4 mb-6 overflow-hidden rounded-2xl bg-white shadow-sm">
          ...
          <div className="mx-4 mt-3 rounded-xl bg-[#f5f4f0] px-3 py-3">
            ...
            <p className="mt-2 text-xs font-semibold text-[#1c1c1e]">Ferritin 280 µg/L · Transferrin saturation 48%</p>
          ...
          <div className="mx-4 mb-3 rounded-xl border border-[#007aff30] bg-[#007aff06] px-3 py-3">
            ...
            <p className="mt-2 text-xs font-semibold text-[#1c1c1e]">Same blood markers + HFE variant detected</p>
            <p className="mt-1 text-xs leading-5 text-[#3a3a3c]">
              Discuss whether HFE-related iron overload evaluation is appropriate given these values.
            </p>
          </div>
